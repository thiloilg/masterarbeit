...
Desweiteren können so Änderungen in dem Aufbau getrennt von den Änderungen in der
...
hat. Desweiteren kann ein Diagramm wie in \Cref{subsec:zuweisungungvondatenquellen} beschrieben,
...
soll in einer Datenbank gespeichert werden. Dadurch ist die Option gegeben, alle
Ressourcen nach Erstellungsdatum zu sortieren. Die IDs der Ressourcen sollen möglichst kompakt gehalten
werden, da diese in der URL angezeigt wird.
