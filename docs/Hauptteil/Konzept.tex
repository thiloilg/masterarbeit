...
\begin{listing}[]
    ...
    \caption{JMESPath Ausgabedaten}
    \label{lst:jmespathausgabedaten}
\end{listing}
...
sieht man eine Abfrage, anhand welcher die Daten Verarbeitet werden. In Quellcode \ref{lst:jmespathausgabedaten}
...
Daten an das Frontend, die in der Frontendanwendung angezeigt werden. 
...
Um die Redundanz in im Datenfluss zu verringern, werden die ausgehenden Nachrichten
so gefiltert, dass für jede Datenquelle nur eine Nachricht versendet wird. 
