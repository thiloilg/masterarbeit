...
Die Speicherung der Daten ist in zwei Abschnitte unterteilt. In \Cref{subsec:aufbaudesdashboards} geht es
um die Persistierung des Aufbaus der Dashboards. Der \Cref{subsec:datenquellenundeinstellungen} handelt
von der Speicherung der Datenquellen sowie jegliche weitere für die Anwendung relevante Speichermechanismen.
...
der Diagramme als Baumstruktur im JSON-Format in der Datenbank persistiert werden. 
