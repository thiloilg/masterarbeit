...
Es ist somit von zwei Services auszugehen: Dem \code{Resource Management Service},
...
Daten an das Frontend, die in der Frontend-Anwendung angezeigt werden. 
In der Abbildung \ref{figure:uebersichtderdatenauslieferung} wird unter anderem
das Prinzip der Filterung und Verteilung der Anfragen dargestellt.
...
mit deren enthaltenen Daten sie ihre Visualisierung neuzeichnen. Der \code{Data Delivery Service}
