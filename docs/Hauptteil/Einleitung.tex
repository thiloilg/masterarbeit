...
Die Masterarbeit ist in neun Kapitel unterteilt. Im folgenden Kapitel geht es um für
...
Das Konzept wird in \Cref{chap:konzept} ausgearbeitet. Die Gliederung des Kapitels
...
In \Cref{chap:implementierung} wird die Implementierung der Anwendung dargestellt. Es
...
Die Auswertung der Resultate findet in \Cref{chap:auswertung} statt. Zur Auswertung werden
die Ergebnisse mit den in \Cref{chap:anforderungsanalyse} gestellten Anforderungen verglichen
