...
Frontend-Anwendung sowie eine Repräsentation einer externen API. Die Frontend-Anwendung
...
einer HTML-Seite. Die Frontend-Anwendung besitzt mehrere Seite, die alle über Suchmaschinen wie Google
...
Hierfür wird der \code{useDrawQuad} Hook verwendet. Zur Errechnung der Position, über der der Typ
...
\code{useArrangement} Hook. Anhand der aus dem \code{useSelectAction} resultierenden Aktion wird
...
Die Frontend-Anwendung besitzt neben den Hooks auch hilfreiche React-Komponenten. So gibt es
