...
Die Produktionsserver (Nodes) sind in einen Manager- und einen Task-Server aufgeteilt. Von dem Manager-Server
aus können Instanzen hinzugefügt und auch wieder entfernt werden. Um die Daten zu persistieren,
ist ein 10GB SSD Volumen an den Manager-Server angebunden. In der Docker-Compose-Datei werden
...
ausgeführt. Die Task-Server werden daraufhin mit dem Manager-Server verbunden.
