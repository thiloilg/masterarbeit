...
Dies geschieht mithilfe des \code{useSelectAction} Hooks. Die Umsetzung orientiert sich eins zu eins an dem
...
mithilfe des \code{useArrangement} Hooks das neue Plugin in die Baumstruktur, die die Positionierung
...
bietet die Anwendung eine Zwei-Faktor-Authentisierung. In \Cref{subsec:authentifizierungsverfahrenundrechteverwaltung} geht die
