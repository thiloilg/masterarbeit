...
In \Cref{sec:frontendanwendung} wird die Umsetzung der progressiven \mbox{Webanwendung}
...
Datenbank. Die Hashes, die die Passwörter repräsentieren, werden mithilfe der Bibliothek \code{bcryptjs} generiert.
