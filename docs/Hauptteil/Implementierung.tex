...
das parallele Arbeiten mehrerer Prozesse gelegt wurde. So ist es mithilfe einer Goroutine möglich,
einen leichtgewichtigen, von der Golang Laufzeit verwalteten, Thread zu starten.
Hierfür wird die Syntax \code{go} gefolgt von einer zu parallelisierenden Funktion benutzt.\cite{GoroutinesExample}
