...
Logger\footnote{https://github.com/winstonjs/winston}. Der HTTP-Verkehr wird mithilfe des Koa-Loggers\footnote{Koa ist ein HTTP Middleware Framework für Node.js.} protokolliert und an den Winston
...
in einem Shell-Script der Befehl \code{service nginx status} aufgerufen. Ist das Resultat positiv, wird
