...
als Verifizierung gespeicherten Hash, wird das JWT nach Ablauf automatisch erneuert. In dem JWT befindet sich die
...
das parallele Arbeiten mehrerer Prozesse gelegt wurde. 

Gerade für das autrechterhalten einer WS-Verbindung
und dem parallelen Verarbeiten von Daten ist die Auslagerung in mehrere Threads sowie die Kommunikation zwischen
 essentiell. Golang besitzt die sogenannte
Goroutine, einen 

So besitzt Golang als Syntax den Befehl \code{go}
