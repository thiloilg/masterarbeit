...
Eine \(N:N\)-Beziehungen ist durch Verweise auf einzigartige Identifikatoren innerhalb einer JSON\hyp{}Datenstruktur abbildbar.
Des Weiteren können mehrere Abfragen untereinander \(N:N\)-Beziehungen beinhalten. Bei der Konzipierung
einer flexiblen Anwendung müssen daher mögliche \(N:N\)-Beziehungen berücksichtigt werden.
...
Wo sind Tests zwingend erforderlich und wo sind sie überflüssig? Um diese Fragen zu beantworten, muss
