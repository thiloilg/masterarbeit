...
dass die Beschaffenheit der Schnittstelle unverändert bleibt, ist somit ein fataler Fehler. Es muss also dafür gesorgt
werden, dass die Software so flexibel gestaltet ist, dass sie mit Änderungen externer Schnittstellen umgehen kann.

Die Anforderungen an die Flexibilität der Software in Bezug auf die Kommunikation mit Schnittstellen wurde bereits
erörtert. Wie sieht es aber mit der Anforderung an die Flexibilität der Daten selbst aus?
...
Die Software sollte aus verschiedenen Perspektiven getestet werden. Zum einen kann man aus
...
Qualitätsmerkmalen der Software testen.\cite{WikiSoftwaretest} Alle diese Aspekte sollten bei
der Umsetzung der Tests beachtet werden.
