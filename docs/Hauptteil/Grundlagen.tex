...
In dem Kapitel der Grundlagen werden die für die Arbeit relevanten Themen, progressive Webanwendungen in \Cref{sec:progressivewebanwendung},
...
Bei der Analyse des unterstützten Funktionsumfangs wurden die neuesten Versionen relevanter Browser\footnote{Stand Januar 2020 (Internet Explorer 11, Edge 79, Firefox 72, Chrome 79, Safari 13, Opera 64, Safari iOS 13.2, Opera Mini 46, Android Browser Chromium 76, Opera Mobile 46, Chrome für Android 79, Firefox für Android 68, UC Browser für Android 12.12 und Samsung Internet 10.1) }
...
Zwei der fünfzehn in \Cref{subsec:markmale} erwähnten Merkmale wurden
...
Trusted Web Activities werden mit \code{activity} Tags in das Android-App-Manifest integriert. Die
...
sowie in der Produktion dieselbe ist. Immer mehr Anbieter stellen Werkzeuge für Continuous Integration (CI) zur Verfügung,
