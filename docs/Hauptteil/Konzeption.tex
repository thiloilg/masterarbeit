...
\Cref{subsec:microservicetechstack} werden die Anforderungen an die Technologien erörtert,
die die Umsetzung einer Microservice-Infrastruktur ermöglichen.
...
\subsection{Anforderungen an einen Microservice Tech Stack}
\label{subsec:microservicetechstack}
