...
nun diese Merkmale? Alex Russell erwähnt in seinem Blogpost dazu folgende Merkmale:
Die PWA soll responsive, netzunabhängig sein, app-ähnliche Navigationsvorgänge bereitstellen,\footnote{Ohne Verwendung von Browser Tabs} 
...
verwenden, auf dem Homescreen installierbar, über Hyperlinks teilbar sowie ohne aufwendigen
...
unterstützen Funktionsumfang von gangigen Browsern in \Cref{subsec:unterstuetzterfunktionsumfanggaengigerbrowser}
...
Wie sieht es mit dem unterstützten Funktionsumfang der Browse aus? 
