...
\footnote{Ein Beispiel für ein Web App Manifest befindet sich unter "Weitere Quellcodeausschnitte" in \Cref{sec:webappmanifest}.}
...
dem Benutzer die Verwendung von im Betriebssystem gehorteten Anmeldedaten zu ermöglichen (Credential Management API).

Bei der Analyse wurden die neuesten Versionen der Browser\footnote{Stand Januar 2020} begutachtet. Aufgrund der Komplexität wurden
die Ergebnisse in \Cref{tab:unterstutzterpwafunktionsumfangteil1} und \Cref{tab:unterstutzterpwafunktionsumfangteil2}
aufgeteilt. Die fünfzehn in \Cref{subsec:markmaleeinerpwa} erwähnten Merkmale wurden auf achtzehn erweitert.
...
% Periodic Background Sync comming in chrome version 80

% Firefox verweist beim speichern der PWA auf dem Desktop auf die von Chrome installierte PWA. 
% Add to homescreen falsch von PWA Detector erkannt.
