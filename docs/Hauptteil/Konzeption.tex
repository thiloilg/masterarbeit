...
zu gewährleisten, reicht ein robustes, selbsterklärendes Verfahren aus. Die Flexibilität hingegen
richtet sich auf die Erstellung neuer Diagramme. In der Regel wird der Kunde lieber aus einer
...
Die Analyse der Anforderungen an die Codebasis ist in drei Bereiche einzuteilen. Als erstes gilt
es die Anforderung an die Testabdeckung zu erörtern. Als zweites wird die Anforderung an die Weiterverwendbarkeit
und als drittes an die Erweiterbarkeit untersucht.

Als erstes stellt sich die Frage, wie es mit den Anforderungen an die Testabdeckung aussieht. 
