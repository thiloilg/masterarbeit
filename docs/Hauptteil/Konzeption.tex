...
OpenAPI-Specification 3.0 ausgestattet. Die Anfragen an die Ressourcen können mehrere Hierarchien an Werten beinhalten.
...
Array und Objekte beinhalten. Analysiert man alle Antworten der bereitgestellten REST API anhand der Kardinalität,
...
Kardinalitäten darstellbar sind.

Analysiert man die maximale Anzahl an Hierarchien der Antworten, 
