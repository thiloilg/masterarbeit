...
(KPIs) abrufen. Viele Produktionshallen besitzen alte Windows-Rechner, welche nicht
...
vorigen Abschnitt über die grafische Benutzeroberfläche debattiert, sollte die Anwendung und
...
die im darauffolgenden Abschnitt erörtert wird, sollte das Laden von Daten schnell und zuverlässig
...
wichtigsten Sicherheitsrisiken von Webanwendungen. Darunter sind unter anderem die Einschleusung
...
zu erörtern. GBO Datacomp erläutert in ihrem Informationsblatt zu dieser Masterarbeit, dass der Benutzer
...
Im zweiten Bereich geht es um die Flexibilität der Visualisierungsmöglichkeiten. Hier sollen die Anforderungen
an die Flexibilität der Visualisierung der Daten anhand von möglichen Fallbeispielen erörtert werden.
