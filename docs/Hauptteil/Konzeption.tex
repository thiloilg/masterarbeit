...
Bereiche gliedern. Im ersten Bereich geht es um die Flexibilität der Software in Bezug auf die der Daten. Hierbei wird ein bedeutsames
...
Man implementiert die benötigten Aufrufe der Datenquelle in der geforderten Reihenfolge in seinen Quellcode.
...
die Beschaffenheit der Schnittstelle nur sehr selten ändert, ist Option eins immernoch plausibel und eventuell
kostengünstiger. 

Will man hingegen ein langlebiges Produkt
