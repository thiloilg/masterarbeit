...
werden sollten. Diese vier Funktionalitäten sind der Kern der Anwendung.


Nun folgen zahlreiche
Implementierungsdetails, die von GBO Datacomp gewünscht sind. 


Unterschiedliche Datenquellen

Doch wie kommen die Daten in die
unterschiedlichen Diagramme? 

Da es sich um ein agiles Dashboardingtool zur Datenanalyse
in einer Microservice-Infrastruktur handelt


Die vier wichtigsten Funktionalitäten

sind die agile Zusammenstellung eines Dashboards sowie die Möglichkeit, Daten aus
externen Quellen zu laden, zu verarbeiten und den Dashboards zuzuweisen. 

Dazu kommen zahlreiche Standartfunktionalitäten

Er umfasst die Authentifizierung der Benutzer,
die Rechteverwaltung, die Auswahl der Sprache, die Navigation durch die Software, die Suche
nach Ressourcen in der Anwendung, einfaches Erstellen von Informationsseiten, das automatische
Aktualisieren von angezeigten Daten sowie die Moglichkeit die Anwendung auch offline zu verwenden.
