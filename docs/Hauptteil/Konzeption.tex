...
Im Frontend sollten vorerst nur komplexe Problemstellungen getestet werden. Integrationstests für Services sind pflicht.

Um abwägen zu können, wo Tests zwingend erforderlich und wo sie nicht notwendig sind
