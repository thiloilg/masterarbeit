...
in die anwendungseigene Datenstruktur übersiedelt werden. Hierfür bietet der Power BI Kosmos eine zusätzliche Software
...
Zu importierende Datenstrukturen, die nicht auf einem relationalen Datenbankmodell basieren, werden mithilfe von Power Query
in ein solches konvertiert. Eine mehrdimensionale JSON-Datei wird somit in eine eindimensionale Tabelle
