...
ist von besonderer Bedeutung, welche Merkmale die einzelnen Komponenten ausmacht.
...
Implementierungsdetails werden in \Cref{chap:komponentendesign} vorgestellt. 
...
werden können. In \Cref{subsec:services} gibt es einen Überblick
über die Services. Hier werden für das System relevante Machenschaften
dargestellt. Abschließend setzt sich die Arbeit in \Cref{subsec:monitoringundwartung}
...
eine dokumentenorientiertes als auch ein relationales Datenbanksystem verwendet. Die Wahl der Datenbankarten wird in
\Cref{subsec:wahlderdatenbankarten} genauer beschrieben. Der Content Delivery Service ist für die Auslieferung
der statischen Dateien des Frontends verantwortlich. Hier ist die Wahl des richtigen Kompressionsverfahrens
ausschlaggebend. Die Content Delivery (zu deutsch Inhaltsauslieferung) behandelt \Cref{subsec:inhaltsauslieferung}.
...
% Performance verbesserung durch Indexing in der RDBMS
