...
mithilfe von Let's Encrypt.\footnote{https://letsencrypt.org/} Eine HTTPS-Verbindung
ist notwendig, um typische Features der PWAs zu ermögliche.\cite{IsHTTPSforPWArequired}
So kann ohne HTTPS keine PWA auf dem Homescreen installiert werden. 
