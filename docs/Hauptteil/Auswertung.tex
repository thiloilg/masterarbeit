...
\begin{figure}
    ...
    \end{center}
    \caption{Antwortzeiten (JMeter Lasttest)}
    \label{figure:antwortzeitenjmeterlasttest}
\end{figure}

Die Lasttestresultate der JMeter-Tests sind auf der Abbildung \ref{figure:antwortzeitenjmeterlasttest}
