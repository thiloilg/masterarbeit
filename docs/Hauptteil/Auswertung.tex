...
\begin{figure}
    \begin{center}
    \includegraphics[scale=0.15]{img/abbildungen/Antwortzeitdiagramm}
    \end{center}
...
Der Test führt folgendes Szenario fünfzig mal in der Sekunde aus:
...
der Leistung ausweist. Die WebSocket-Verbindung schließt nicht immer ordnungsgemäß.
Der HTTP-Statuscode 101 steht für den Protokollwechsel zu dem WebSocket-Protokoll.
Bei einem erfolgreichen Schließen der Verbindung bekommt der Client den Close Code 1000.
Aus den von JMeter aufgenommenen Reportkennzahlen geht hervor, dass sich die Antwortzeit
der der Landing-Page bei ca. 
