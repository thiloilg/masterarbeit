...
\begin{figure}
    \begin{center}
    \includegraphics[scale=0.125]{img/abbildungen/Antwortzeitdiagramm3}
    \end{center}
...
Daten einer einzelnen Abfolge an Anfragen und deren Antworten aufgelistet. Es ist anzumerken,
dass nur die Endpunkte der Services getestet werden. Die eigentliche Frontendanwendung
wird nur teilweise geladen und nicht ausgeführt. 
...
die \code{index.html} der Frontendanwendung gehen. Für den Test
