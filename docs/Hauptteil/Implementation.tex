...
16GB RAM und  haben 4 VCPUs, 16GB RAM und 160GB SSD-Speicher.\footnote{Die Prozessorleistung
kann aufgrund der Komplexität der Serverfarmen und dessen verschiedene Versionen von
Prozessoren variieren. In der Regel sind es Intel Skylake Xeon
CPUs mit 2.1 GHz.\cite{CPUusedInHetznerCLoud}}


der Server für die Testphase 2 VCPU, 8GB RAM und 80GB SSD-Speicher und
der Server für die Produktion hat 8 VCPUs, 32GB RAM, 240GB SSD-Speicher und ein 10GB Volume für Persistierung der Datenbankdaten.
...
Die Domain \code{blicc.org} dient als Hauptdomain und wird in der Produktion verwendet. Der Name Blicc
...
überteuert angeboten wurde. Die Domain für den Server der Testphase ist \code{testing-stage.org}.
Die beiden Domains besitzten die Subdomains \code{api} und \code{delivery}. Die Subdomain \code{api} verweist
auf die Resource Management API; die Subdomain \code{delivery} verweist auf die Data Delivery API.
